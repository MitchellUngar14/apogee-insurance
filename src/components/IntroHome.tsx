...
const SERVICE_CONFIG = [
  {
    ...
    url: process.env.NEXT_PUBLIC_QUOTING_URL || 'https://apogee-insurance-quoting.vercel.app',
  ...
  },
  {
    ...
    url: process.env.NEXT_PUBLIC_CUSTOMER_SERVICE_URL || 'https://apogee-insurance-customer-service.vercel.app',
  ...
  },
  {
    ...
    url: process.env.NEXT_PUBLIC_BENEFIT_DESIGNER_URL || 'https://apogee-insurance-benefit-designer.vercel.app',
