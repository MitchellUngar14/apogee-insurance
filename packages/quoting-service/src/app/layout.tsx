...
export const metadata: Metadata = {
  title: "Apogee Quoting",
  description: "Apogee Insurance Quoting Service",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        <HeaderProvider>
          <header className="bg-soft-blue-500 text-white p-4 shadow-md" style={{ backgroundColor: '#22c55e' }}>
